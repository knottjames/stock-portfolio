        ...
        <div className="grid gap-6 items-center">
          <div className="flex flex-col justify-center space-y-8 text-center">
            <div className="space-y-2">
              <h1 className="text-3xl font-bold tracking-tighter sm:text-5xl xl:text-6xl/none bg-clip-text text-transparent  bg-black">
                Portfolio Tracker
              </h1>

              <p className="max-w-[850px] text-zinc-500 md:text-xl mx-auto">
            ...
            <div className="w-full max-w-full space-y-4 mx-auto">
              <div className="grid grid-cols-3 gap-8">
                <div className="flex flex-col items-center space-y-2 border-gray-800 p-4 rounded-lg">
                  ...
                  <h2 className="text-xl font-bold text-black ">Portfolio Performnance</h2>
                ...
                <div className="flex flex-col items-center space-y-2 border-gray-800 p-4 rounded-lg">
                  ...
                  <h2 className="text-xl font-bold text-black ">Portfolio Customisation</h2>
                  <p className="text-zinc-500 ">
                ...
                <div className="flex flex-col items-center space-y-2 border-gray-800 p-4 rounded-lg">
                  ...
                  <h2 className="text-xl font-bold text-black ">Powerful Search</h2>
                  <p className="text-zinc-500 ">
